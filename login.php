...
?>
<!-- we are getting a redirect on login button submission - possible redirect/Index routing error  -->
<!DOCTYPE HTML>
<html lang="en-us">
	<head>
		<meta charset="UTF-8">
...
<div class="col-md-6 cards">
		<div class="authincation-content">
			...
			<a class="login-logo " href="">
				<img src="/img/logo.jpg" alt="" height="200px" width="auto" >
			</a>
				<div class="mb-4">
				...
				<div class="new-account mt-2 tag">
					<b>If you have any requirement related to Project Development : <a href="https://api.whatsapp.com/send?phone=254711637374">Click here</a></b>
					</p>
				</div>
			</div>
		</div>
