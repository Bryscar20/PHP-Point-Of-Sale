...
<head>
  ...
  <title>Liqour Store Billing and Inventory Software</title>
...
<marquee behavior="scroll" direction="left" scrollamount="4"><p style="color: blue;">
                This Project is developed to help ease your business operations.</p>
            </marquee>
 <!-- Right navbar links -->
      ...
      <div class="notice">
                 <li>
                     <i class="material-symbols-outlined">
                         <a href="https://www.youtube.com/channel/UCYY0SKZHh47GP6XpZT5b20g" target="_blank"> notifications</a></i>
                    </li>
                    <li> <i class="material-symbols-outlined"><a href="mailto: lifiteq20@gmail.com" target="_blank"> mail</a></i></li>
                    <li>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
          <img src="https://img.freepik.com/premium-vector/woman-avatar-profile-round-icon_24640-14042.jpg">
            <span>Bryson<strong> Developer</strong></span>
        </a>
